...
def send_otp_email(recipient_email, otp, name='', logger=None):
    """
    ...
    try:
        ...
        <body>
            <div class="container">
                ...
                <div class="otp-box">
                    <div style="font-size: 14px; margin-bottom: 10px; opacity: 0.9;">Your verification code:</div>
                    <div class="otp-code">{otp}</div>
                    <div style="font-size: 12px; margin-top: 10px; opacity: 0.8;">This code expires in 15 minutes</div>
                </div>
                ...
                <p class="message" style="color: #999; font-size: 12px;">
                    If you didn't create an account, please ignore this email.
                </p>
                
                <div class="footer">
                    <p>E-ZPass Toll Dashboard</p>
...
E-ZPass Toll Dashboard
{datetime.now().strftime('%B %d, %Y')}
        """
        
        # Create message
        msg = MIMEMultipart('alternative')
        msg['Subject'] = 'Verify Your Email - E-ZPass Account'
        msg['From'] = SMTP_USERNAME
        msg['To'] = recipient_email
        ...
        try:
            ...
            server.send_message(msg)
            log(f"✅ OTP email sent successfully to {recipient_email}")
